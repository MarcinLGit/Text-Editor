...
std::tuple<std::map<int, std::string>, std::map<int, std::string>, std::vector<int>> FindModifications(std::map<int, std::string>& deleted_file_one_indexes, std::map<int, std::string>& added_file_two_indexes);
